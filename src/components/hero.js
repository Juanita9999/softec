    ...
    return (
        <div className="hero">
            ...
            <div className='hero-image'>
                ...
                <img className='card' src='images/card.png'/>
               
               
                <img className='spotify' src='images/spotify.png'/>
                
               
                <img className='total' src='images/total.png'/>
